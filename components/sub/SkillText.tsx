...
const SkillText = ({ isDarkMode = true }: SkillTextProps) => {
  ...
  return (
    <div className='w-full h-auto flex flex-col gap-5 items-center justify-center'>
      <div className={`text-center text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r ${headingGradient} transition-colors duration-500`}>
        Technical Expertise
      </div>
      
      <div className={`${textColor} text-center text-xl max-w-3xl transition-colors duration-500`}>
